...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v3/apps/{app}/deploy/image": {
            "post": {
                ...
                "description": "Deploys a pre-built container image to an application on Runway without going through the build pipeline",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Deploy pre-built image to Runway app",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Application name",
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_endpoints.deployImageRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Successfully deployed image",
                        "schema": {
        ...
        "/v3/apps/{app}/registry": {
            "put": {
                ...
                "description": "Associates a registry with an application for private image pulls.\nThe registry credentials are stored in the app config. The K8s pull\nsecret is created/updated on the next deployment.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.RegistrySetRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Registry associated with the app",
                        "schema": {
                    ...
                    "404": {
                        "description": "App or registry not found",
                        "schema": {
                            "$ref": "#/definitions/github_com_hostwithquantum_runway-controller-next_internal_app.StatusErrResponse"
                        }
                    },
            ...
            "delete": {
                ...
                "description": "Resets the registry for an application to the user's managed registry.\nIf no managed registry exists the registry field is cleared.",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/v3/apps/{app}/status": {
            "get": {
                ...
                "description": "Returns the current status of an application on Runway.\nThe ` + "`" + `status` + "`" + ` field is the combined user-facing value:\n` + "`" + `build pending` + "`" + ` | ` + "`" + `building` + "`" + ` | ` + "`" + `not deployed` + "`" + ` | ` + "`" + `deploying` + "`" + ` |\n` + "`" + `restarting` + "`" + ` | ` + "`" + `crashing` + "`" + ` | ` + "`" + `running` + "`" + ` | ` + "`" + `crashed` + "`" + ` | ` + "`" + `stopped` + "`" + `\n` + "`" + `deployment_status` + "`" + ` reflects the stored app state\n(` + "`" + `not_deployed` + "`" + ` | ` + "`" + `deploying` + "`" + ` | ` + "`" + `restarting` + "`" + ` | ` + "`" + `crashing` + "`" + ` | ` + "`" + `running` + "`" + ` | ` + "`" + `crashed` + "`" + ` | ` + "`" + `stopped` + "`" + `).\n` + "`" + `build_status` + "`" + ` is the active build state (` + "`" + `pending` + "`" + ` | ` + "`" + `running` + "`" + `), empty if no active build.\n` + "`" + `integrations` + "`" + ` lists active integrations derived from config (e.g. ` + "`" + `[\"tailscale\"]` + "`" + `), empty if none.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/api.AppStatusResponse"
                        }
                    },
                    "400": {
                        "description": "No status info for a service",
                        "schema": {
                            "$ref": "#/definitions/github_com_hostwithquantum_runway-controller-next_internal_app.StatusErrResponse"
                        }
                    },
        ...
        "/v3/registries": {
            "get": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/api.RegistryListResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
            ...
            "post": {
                ...
                "description": "Adds a new external container registry, or updates credentials if one\nwith the same hostname already exists. Managed registries cannot be updated here.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Add or update registry",
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.RegistryCreateRequest"
                        }
                    }
                ],
                "responses": {
                    ...
                    "403": {
                        "description": "Cannot update managed registry",
                        "schema": {
                            "$ref": "#/definitions/github_com_hostwithquantum_runway-controller-next_internal_app.StatusErrResponse"
                        }
                    },
            ...
            "delete": {
                ...
                "description": "Removes an external container registry. Managed registries cannot be deleted.",
                "produces": [
                    "application/json"
                ],
                "tags": [
                ...
                "responses": {
                    ...
                    "403": {
                        "description": "Managed registry cannot be deleted",
                        "schema": {
                            "$ref": "#/definitions/github_com_hostwithquantum_runway-controller-next_internal_app.StatusErrResponse"
                        }
                    },
        ...
        "/v3/services/{app}/backups": {
            "get": {
                ...
                "description": "Lists all backups for a service on Runway",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/api.ServiceBackupListResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request",
            ...
            "post": {
                ...
                "description": "Creates an immediate backup for a service on Runway",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Create immediate backup",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Service name",
                ...
                "responses": {
                    "202": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/api.ServiceBackupCreateResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request or name mismatch",
                        "schema": {
                            "$ref": "#/definitions/github_com_hostwithquantum_runway-controller-next_internal_app.StatusErrResponse"
                        }
                    },
                    ...
                    "424": {
                        "description": "Failed to submit backup job",
                        "schema": {
                            "$ref": "#/definitions/github_com_hostwithquantum_runway-controller-next_internal_app.StatusErrResponse"
                        }
                    }
        ...
        "/v3/services/{app}/backups/{name}": {
            ...
            "delete": {
                ...
                "description": "Deletes a specific backup for a service on Runway",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/api.ServiceBackupDeleteResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request",
        ...
        "/v3/volumes/{name}": {
            "get": {
                ...
                "description": "Returns details of a specific storage volume on Runway, including its replica set.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
    ...
    "definitions": {
        ...
        "api.Registry": {
            ...
            "properties": {
                "hostname": {
                    "description": "URL is the full URL of the registry, including scheme and optional path\n(e.g. \"https://r.example.com/myproject\"). Path components scope\ncredentials to a sub-path of the registry host.",
                    "type": "string"
                },
                "managed": {
                    "type": "boolean"
        ...
        "api.RegistryCreateRequest": {
            ...
            "properties": {
                "hostname": {
                    "description": "URL is the full URL of the registry, including scheme and optional path\n(e.g. \"https://r.example.com/myproject\"). Must begin with https://.",
                    "type": "string"
                },
                "password": {
                    "type": "string"
        ...
        "api.RegistrySetRequest": {
            ...
            "properties": {
                "url": {
                    "description": "URL is the full registry URL, including scheme and optional path\n(e.g. \"https://r.example.com/myproject\").",
                    "type": "string"
                }
            }
        },
        ...
        "api.ServiceBackupCreateResponse": {
            "type": "object",
            "properties": {
                "status": {
                    "type": "string"
        ...
        "api.ServiceBackupDeleteResponse": {
            "type": "object",
            "properties": {
                "status": {
                    "type": "string"
        ...
        "api.ServiceBackupListResponse": {
            ...
            "properties": {
                ...
                "results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/api.ServiceBackup"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "api.ServiceCreateRequest": {
            ...
            "properties": {
                "bootstrap_from": {
                    "$ref": "#/definitions/api.ServiceCreateBootstrap"
                },
                "name": {
                    "type": "string"
                },
        ...
        "api.VolumeEntity": {
            ...
            "properties": {
                "app": {
                    "description": "the app/service this belongs to",
                    "type": "string"
                },
                "attachable": {
                    "type": "boolean"
                ...
                "replicas": {
                    "description": "volumes that replicate this",
                    "type": "array",
                    "items": {
                        "type": "string"
                    }
        ...
        "internal_endpoints.deployImageRequest": {
            "type": "object",
            "required": [
                "image"
            ],
